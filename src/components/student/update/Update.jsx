...
export default class StudentUpdate extends React.Component {
  ...
  async componentDidMount() {
    ...
    await axios
      .get(`https://sams-backend.vercel.app/student/get/${id}`)
      .then((res) => {
        message.destroy();
        message.open({
          type: "success",
  ...
  async next(img) {
    if (img == "") {
      ...
      const id = localStorage.getItem("id");
      await axios
        .patch(`https://sams-backend.vercel.app/student/update/${id}`, data)
        .then((res) => {
          message.destroy();
          message.open({
            type: "success",
  ...
  async studentDelete() {
    ...
    const id = localStorage.getItem("id");
    await axios
      .delete(`https://sams-backend.vercel.app/student/delete/${id}`)
      .then((res) => {
        message.destroy();
        message.open({
          type: "success",
  ...
  async changeStatus() {
    ...
    const id = localStorage.getItem('id');
    await axios
      .patch(`https://sams-backend.vercel.app/student/changestatus/${id}`)
      .then((res) => {
        message.destroy();
        message.open({
          type: 'success',
